...
class DataBuilder(ABC):
    ...
    def build_examples(self):
        ...
        if save_mode == 'jsonl' or save_mode == 'both':
            ...
            jsonl_writer = None
        num_examples = 0
        model_features = self.TASK_FEATURES  # feature_id, input_ids, segment_ids
        label_features = self.TASK_LABELS  # cls, answer_start, answer_end
        detail_features = self.DETAIL_FEATURES  # ('feature_id', 'question', 'question_tokens', 'context', 'context_tokens', 'context_spans', 'label')
