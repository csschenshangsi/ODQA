...
max_first_length_map = {  # max_first_length is the max length of the question text
    'mnli': 85,
    'qqp': 40,
    'boolq': 15,
    'squad_v1.1': 25,
...
def get_task_model_class(model_name, task):
    ...
    """
    import importlib
    mapped_task = task_map.get(task, task)  # 'qa'
    module = importlib.import_module('tasks.{}_{}'.format(  # tasks.qa_bert
        mapped_task, model_name))
    task_model_class = getattr(module, '{}{}'.format(model_name.capitalize(),  # BertQa
