...
from common import layers  # tf.keras.layers
...
class EbertQa(QaModel):
    def __init__(self, config, **kwargs):
        ...
        task = config.task
        replace_map = OrderedDict(  # replace what?
        ...
        self.replace_map = replace_map if config.use_replace_map else {}  # where used?
        self.encoded_output = None
        self.q_embeddings = None  # first_embeddings
        self.c_embeddings = None  # second_embeddings
        self.logits = None
